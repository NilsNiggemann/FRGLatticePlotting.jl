module FRGLatticePlotting
    ...
    include("helpers.jl")
    export hhlplane,normalTohhlplane,xyplane,zzerocut,sphereplane,hhllabels,xylabels,zzerolabels,normalTohhllabels,strd,strd3,getPairs,DimerResponse,DimerResponse_Keles,allOccurIn,findNames,NameFilter,OnlyIndex,getNumberFromName,stringLatex,getFourier
